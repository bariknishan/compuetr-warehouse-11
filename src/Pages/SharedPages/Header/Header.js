            ...
            <Nav>

              {
                user && <>
                  ...
                  <Nav.Link as={Link} to="manageinventories" className='fs-5 fw-bold text-white '>
                    ManageInventory
                  </Nav.Link>
                  <Nav.Link as={Link} to="additems" className='fs-5 fw-bold text-white '>
                    AddItems
                  </Nav.Link>
...

              {
                ...
                user ?
                  ...
                  :
                  <Nav.Link as={Link} to="login" className='fs-5 text-warning  login '>
                    LOG IN
                  </Nav.Link>
              }
